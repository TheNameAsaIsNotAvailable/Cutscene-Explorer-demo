...
- (08c) Particles deactivate when cutscene is unloaded, regardless of button config
...
- (20b) Particles remain active when cutscene is unloaded, regardless of button config
