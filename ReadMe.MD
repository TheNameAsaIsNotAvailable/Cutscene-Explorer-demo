...
5. [Cutscene Car Function] Toggles the functionality of any 'cutscene-only' cars for use afterwards. Note that the toggle setting will apply to the *next* time a cinematic is run. Off by default.
